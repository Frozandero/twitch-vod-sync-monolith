...
- Keep the interface compact: no slogan/sidebar recording list, all recordings in Links, exact non-match gaps, per-player controls, watch mode, and a seekable shared timeline.
